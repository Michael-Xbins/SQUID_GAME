...
const (
	...
	MessageType_TradeRecordNotify_       MessageType = 22 //交易记录通知(每分钟成交的平均值)
	MessageType_BuyOrderNotify_          MessageType = 23 //购买下单通知(增量)
	MessageType_SellOrderNotify_         MessageType = 24 //出售下单通知(增量)
	MessageType_BuyOrderListNotify_      MessageType = 25 //购买下单通知(全量) top 5 时间排序
	MessageType_SellOrderListNotify_     MessageType = 26 //出售下单通知(全量) top 5 时间排序
	MessageType_BuySuccessNotify_        MessageType = 27 //撮合购买成功通知
	MessageType_SellSuccessNotify_       MessageType = 28 //撮合出售成功通知
	MessageType_CloseMarketNotify_       MessageType = 29 //关闭市场通知
	MessageType_OpenMarketNotify_        MessageType = 30 //开启市场通知
)
...
var (
	MessageType_name = map[int32]string{
		...
		20: "RechargeNotify_",
		21: "CloseConnNotify_",
		22: "TradeRecordNotify_",
		23: "BuyOrderNotify_",
		24: "SellOrderNotify_",
		25: "BuyOrderListNotify_",
		26: "SellOrderListNotify_",
		27: "BuySuccessNotify_",
		28: "SellSuccessNotify_",
		29: "CloseMarketNotify_",
		30: "OpenMarketNotify_",
	}
	MessageType_value = map[string]int32{
		...
		"RechargeNotify_":          20,
		"CloseConnNotify_":         21,
		"TradeRecordNotify_":       22,
		"BuyOrderNotify_":          23,
		"SellOrderNotify_":         24,
		"BuyOrderListNotify_":      25,
		"SellOrderListNotify_":     26,
		"BuySuccessNotify_":        27,
		"SellSuccessNotify_":       28,
		"CloseMarketNotify_":       29,
		"OpenMarketNotify_":        30,
	}
)
...
type ClientResponse struct {
	...
	//	*ClientResponse_TradeRecordNotify
	//	*ClientResponse_BuyOrderNotify
	//	*ClientResponse_SellOrderNotify
	//	*ClientResponse_BuyOrderListNotify
	//	*ClientResponse_SellOrderListNotify
	//	*ClientResponse_BuySuccessNotify
	//	*ClientResponse_SellSuccessNotify
	//	*ClientResponse_CloseMarketNotify
	//	*ClientResponse_OpenMarketNotify
...
func (x *ClientResponse) GetTradeRecordNotify() *TradeRecordNotify {
	if x, ok := x.GetMessage().(*ClientResponse_TradeRecordNotify); ok {
		return x.TradeRecordNotify
	}
	return nil
}

func (x *ClientResponse) GetBuyOrderNotify() *BuyOrderNotify {
	if x, ok := x.GetMessage().(*ClientResponse_BuyOrderNotify); ok {
		return x.BuyOrderNotify
	}
	return nil
}

func (x *ClientResponse) GetSellOrderNotify() *SellOrderNotify {
	if x, ok := x.GetMessage().(*ClientResponse_SellOrderNotify); ok {
		return x.SellOrderNotify
	}
	return nil
}

func (x *ClientResponse) GetBuyOrderListNotify() *BuyOrderListNotify {
	if x, ok := x.GetMessage().(*ClientResponse_BuyOrderListNotify); ok {
		return x.BuyOrderListNotify
	}
	return nil
}

func (x *ClientResponse) GetSellOrderListNotify() *SellOrderListNotify {
	if x, ok := x.GetMessage().(*ClientResponse_SellOrderListNotify); ok {
		return x.SellOrderListNotify
	}
	return nil
}

func (x *ClientResponse) GetBuySuccessNotify() *BuySuccessNotify {
	if x, ok := x.GetMessage().(*ClientResponse_BuySuccessNotify); ok {
		return x.BuySuccessNotify
	}
	return nil
}

func (x *ClientResponse) GetSellSuccessNotify() *SellSuccessNotify {
	if x, ok := x.GetMessage().(*ClientResponse_SellSuccessNotify); ok {
		return x.SellSuccessNotify
	}
	return nil
}

func (x *ClientResponse) GetCloseMarketNotify() *CloseMarketNotify {
	if x, ok := x.GetMessage().(*ClientResponse_CloseMarketNotify); ok {
		return x.CloseMarketNotify
	}
	return nil
}

func (x *ClientResponse) GetOpenMarketNotify() *OpenMarketNotify {
	if x, ok := x.GetMessage().(*ClientResponse_OpenMarketNotify); ok {
		return x.OpenMarketNotify
	}
	return nil
}
...
type ClientResponse_TradeRecordNotify struct {
	TradeRecordNotify *TradeRecordNotify `protobuf:"bytes,23,opt,name=tradeRecordNotify,proto3,oneof"`
}

type ClientResponse_BuyOrderNotify struct {
	BuyOrderNotify *BuyOrderNotify `protobuf:"bytes,24,opt,name=buyOrderNotify,proto3,oneof"`
}

type ClientResponse_SellOrderNotify struct {
	SellOrderNotify *SellOrderNotify `protobuf:"bytes,25,opt,name=sellOrderNotify,proto3,oneof"`
}

type ClientResponse_BuyOrderListNotify struct {
	BuyOrderListNotify *BuyOrderListNotify `protobuf:"bytes,26,opt,name=buyOrderListNotify,proto3,oneof"`
}

type ClientResponse_SellOrderListNotify struct {
	SellOrderListNotify *SellOrderListNotify `protobuf:"bytes,27,opt,name=sellOrderListNotify,proto3,oneof"`
}

type ClientResponse_BuySuccessNotify struct {
	BuySuccessNotify *BuySuccessNotify `protobuf:"bytes,28,opt,name=buySuccessNotify,proto3,oneof"`
}

type ClientResponse_SellSuccessNotify struct {
	SellSuccessNotify *SellSuccessNotify `protobuf:"bytes,29,opt,name=sellSuccessNotify,proto3,oneof"`
}

type ClientResponse_CloseMarketNotify struct {
	CloseMarketNotify *CloseMarketNotify `protobuf:"bytes,30,opt,name=closeMarketNotify,proto3,oneof"`
}

type ClientResponse_OpenMarketNotify struct {
	OpenMarketNotify *OpenMarketNotify `protobuf:"bytes,31,opt,name=openMarketNotify,proto3,oneof"`
}
...
func (*ClientResponse_TradeRecordNotify) isClientResponse_Message() {}

func (*ClientResponse_BuyOrderNotify) isClientResponse_Message() {}

func (*ClientResponse_SellOrderNotify) isClientResponse_Message() {}

func (*ClientResponse_BuyOrderListNotify) isClientResponse_Message() {}

func (*ClientResponse_SellOrderListNotify) isClientResponse_Message() {}

func (*ClientResponse_BuySuccessNotify) isClientResponse_Message() {}

func (*ClientResponse_SellSuccessNotify) isClientResponse_Message() {}

func (*ClientResponse_CloseMarketNotify) isClientResponse_Message() {}

func (*ClientResponse_OpenMarketNotify) isClientResponse_Message() {}
...
type TradeRecordNotify struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Timestamp int64 `protobuf:"varint,1,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	AvgPrice  int64 `protobuf:"varint,2,opt,name=avgPrice,proto3" json:"avgPrice,omitempty"`
}

func (x *TradeRecordNotify) Reset() {
	*x = TradeRecordNotify{}
	if protoimpl.UnsafeEnabled {
...
func (x *TradeRecordNotify) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TradeRecordNotify) ProtoMessage() {}

func (x *TradeRecordNotify) ProtoReflect() protoreflect.Message {
	mi := &file_message_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TradeRecordNotify.ProtoReflect.Descriptor instead.
func (*TradeRecordNotify) Descriptor() ([]byte, []int) {
	return file_message_proto_rawDescGZIP(), []int{26}
}

func (x *TradeRecordNotify) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *TradeRecordNotify) GetAvgPrice() int64 {
	if x != nil {
		return x.AvgPrice
	}
	return 0
...
type BuyOrderNotify struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BuyOrderInfo *BuyOrderInfo `protobuf:"bytes,1,opt,name=buyOrderInfo,proto3" json:"buyOrderInfo,omitempty"`
}

func (x *BuyOrderNotify) Reset() {
	*x = BuyOrderNotify{}
	if protoimpl.UnsafeEnabled {
...
func (x *BuyOrderNotify) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BuyOrderNotify) ProtoMessage() {}

func (x *BuyOrderNotify) ProtoReflect() protoreflect.Message {
	mi := &file_message_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BuyOrderNotify.ProtoReflect.Descriptor instead.
func (*BuyOrderNotify) Descriptor() ([]byte, []int) {
	return file_message_proto_rawDescGZIP(), []int{27}
}

func (x *BuyOrderNotify) GetBuyOrderInfo() *BuyOrderInfo {
	if x != nil {
		return x.BuyOrderInfo
	}
	return nil
}

type SellOrderNotify struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SellOrderInfo *SellOrderInfo `protobuf:"bytes,1,opt,name=sellOrderInfo,proto3" json:"sellOrderInfo,omitempty"`
}

func (x *SellOrderNotify) Reset() {
	*x = SellOrderNotify{}
	if protoimpl.UnsafeEnabled {
...
func (x *SellOrderNotify) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SellOrderNotify) ProtoMessage() {}

func (x *SellOrderNotify) ProtoReflect() protoreflect.Message {
	mi := &file_message_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SellOrderNotify.ProtoReflect.Descriptor instead.
func (*SellOrderNotify) Descriptor() ([]byte, []int) {
	return file_message_proto_rawDescGZIP(), []int{28}
}

func (x *SellOrderNotify) GetSellOrderInfo() *SellOrderInfo {
	if x != nil {
		return x.SellOrderInfo
	}
	return nil
}
...
func (x *BuyOrderInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BuyOrderInfo) ProtoMessage() {}

func (x *BuyOrderInfo) ProtoReflect() protoreflect.Message {
	mi := &file_message_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BuyOrderInfo.ProtoReflect.Descriptor instead.
func (*BuyOrderInfo) Descriptor() ([]byte, []int) {
	return file_message_proto_rawDescGZIP(), []int{29}
}

func (x *BuyOrderInfo) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *BuyOrderInfo) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *BuyOrderInfo) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *SellOrderInfo) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *SellOrderInfo) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *SellOrderInfo) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
type BuyOrderListNotify struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BuyOrderInfo []*BuyOrderInfo `protobuf:"bytes,1,rep,name=buyOrderInfo,proto3" json:"buyOrderInfo,omitempty"`
}

func (x *BuyOrderListNotify) Reset() {
	*x = BuyOrderListNotify{}
	if protoimpl.UnsafeEnabled {
...
func (x *BuyOrderListNotify) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BuyOrderListNotify) ProtoMessage() {}

func (x *BuyOrderListNotify) ProtoReflect() protoreflect.Message {
	mi := &file_message_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BuyOrderListNotify.ProtoReflect.Descriptor instead.
func (*BuyOrderListNotify) Descriptor() ([]byte, []int) {
	return file_message_proto_rawDescGZIP(), []int{31}
}

func (x *BuyOrderListNotify) GetBuyOrderInfo() []*BuyOrderInfo {
	if x != nil {
		return x.BuyOrderInfo
	}
	return nil
...
type SellOrderListNotify struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SellOrderInfo []*SellOrderInfo `protobuf:"bytes,1,rep,name=sellOrderInfo,proto3" json:"sellOrderInfo,omitempty"`
}

func (x *SellOrderListNotify) Reset() {
	*x = SellOrderListNotify{}
	if protoimpl.UnsafeEnabled {
...
func (x *SellOrderListNotify) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SellOrderListNotify) ProtoMessage() {}

func (x *SellOrderListNotify) ProtoReflect() protoreflect.Message {
	mi := &file_message_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SellOrderListNotify.ProtoReflect.Descriptor instead.
func (*SellOrderListNotify) Descriptor() ([]byte, []int) {
	return file_message_proto_rawDescGZIP(), []int{32}
}

func (x *SellOrderListNotify) GetSellOrderInfo() []*SellOrderInfo {
	if x != nil {
		return x.SellOrderInfo
	}
	return nil
...
type BuySuccessNotify struct {
	...
	Voucher int64 `protobuf:"varint,3,opt,name=voucher,proto3" json:"voucher,omitempty"`
	Balance int64 `protobuf:"varint,4,opt,name=balance,proto3" json:"balance,omitempty"`
}

func (x *BuySuccessNotify) Reset() {
	*x = BuySuccessNotify{}
	if protoimpl.UnsafeEnabled {
...
func (x *BuySuccessNotify) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BuySuccessNotify) ProtoMessage() {}

func (x *BuySuccessNotify) ProtoReflect() protoreflect.Message {
	mi := &file_message_proto_msgTypes[33]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BuySuccessNotify.ProtoReflect.Descriptor instead.
func (*BuySuccessNotify) Descriptor() ([]byte, []int) {
	return file_message_proto_rawDescGZIP(), []int{33}
}

func (x *BuySuccessNotify) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *BuySuccessNotify) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *BuySuccessNotify) GetVoucher() int64 {
	if x != nil {
		return x.Voucher
	}
	return 0
...
func (x *BuySuccessNotify) GetBalance() int64 {
	if x != nil {
		return x.Balance
	}
	return 0
...
func (x *SellSuccessNotify) Reset() {
	*x = SellSuccessNotify{}
	if protoimpl.UnsafeEnabled {
...
func (x *SellSuccessNotify) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SellSuccessNotify) ProtoMessage() {}

func (x *SellSuccessNotify) ProtoReflect() protoreflect.Message {
	mi := &file_message_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SellSuccessNotify.ProtoReflect.Descriptor instead.
func (*SellSuccessNotify) Descriptor() ([]byte, []int) {
	return file_message_proto_rawDescGZIP(), []int{34}
}

func (x *SellSuccessNotify) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *SellSuccessNotify) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *SellSuccessNotify) GetVoucher() int64 {
	if x != nil {
		return x.Voucher
	}
	return 0
...
func (x *SellSuccessNotify) GetBalance() int64 {
	if x != nil {
		return x.Balance
	}
	return 0
...
type CloseMarketNotify struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *CloseMarketNotify) Reset() {
	*x = CloseMarketNotify{}
	if protoimpl.UnsafeEnabled {
...
func (x *CloseMarketNotify) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CloseMarketNotify) ProtoMessage() {}

func (x *CloseMarketNotify) ProtoReflect() protoreflect.Message {
	mi := &file_message_proto_msgTypes[35]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CloseMarketNotify.ProtoReflect.Descriptor instead.
func (*CloseMarketNotify) Descriptor() ([]byte, []int) {
	return file_message_proto_rawDescGZIP(), []int{35}
}

type OpenMarketNotify struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ClosePrice int64 `protobuf:"varint,1,opt,name=closePrice,proto3" json:"closePrice,omitempty"`
}

func (x *OpenMarketNotify) Reset() {
	*x = OpenMarketNotify{}
	if protoimpl.UnsafeEnabled {
...
func (x *OpenMarketNotify) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OpenMarketNotify) ProtoMessage() {}

func (x *OpenMarketNotify) ProtoReflect() protoreflect.Message {
	mi := &file_message_proto_msgTypes[36]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OpenMarketNotify.ProtoReflect.Descriptor instead.
func (*OpenMarketNotify) Descriptor() ([]byte, []int) {
	return file_message_proto_rawDescGZIP(), []int{36}
}

func (x *OpenMarketNotify) GetClosePrice() int64 {
	if x != nil {
		return x.ClosePrice
	}
	return 0
...
var file_message_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xa7, 0x12, 0x0a, 0x0e, 0x43, 0x6c, 0x69,
	...
	,
	...
	,
	...
	0x28, 0x03, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x4b, 0x0a, 0x0d, 0x53, 0x65, 0x6c,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x12, 0x18, 0x0a, 0x07,
	0x76, 0x6f, 0x75, 0x63, 0x68, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x76,
	0x6f, 0x75, 0x63, 0x68, 0x65, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63,
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65,
	0x22, 0x73, 0x0a, 0x11, 0x53, 0x65, 0x6c, 0x6c, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x4e,
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01,
	...
	,
...
var file_message_proto_goTypes = []any{
	...
	(*TradeRecordNotify)(nil),       // 28: message.TradeRecordNotify
	(*BuyOrderNotify)(nil),          // 29: message.BuyOrderNotify
	(*SellOrderNotify)(nil),         // 30: message.SellOrderNotify
	(*BuyOrderInfo)(nil),            // 31: message.BuyOrderInfo
	(*SellOrderInfo)(nil),           // 32: message.SellOrderInfo
	(*BuyOrderListNotify)(nil),      // 33: message.BuyOrderListNotify
	(*SellOrderListNotify)(nil),     // 34: message.SellOrderListNotify
	(*BuySuccessNotify)(nil),        // 35: message.BuySuccessNotify
	(*SellSuccessNotify)(nil),       // 36: message.SellSuccessNotify
	(*CloseMarketNotify)(nil),       // 37: message.CloseMarketNotify
	(*OpenMarketNotify)(nil),        // 38: message.OpenMarketNotify
	nil,                             // 39: message.TotalAmountChangeNotify.TotalAmountsEntry
	nil,                             // 40: message.LadderStageNotify.BetsEntry
	nil,                             // 41: message.LadderBetInfoNotify.BetsEntry
}
var file_message_proto_depIdxs = []int32{
	...
	28, // 23: message.ClientResponse.tradeRecordNotify:type_name -> message.TradeRecordNotify
	29, // 24: message.ClientResponse.buyOrderNotify:type_name -> message.BuyOrderNotify
	30, // 25: message.ClientResponse.sellOrderNotify:type_name -> message.SellOrderNotify
	33, // 26: message.ClientResponse.buyOrderListNotify:type_name -> message.BuyOrderListNotify
	34, // 27: message.ClientResponse.sellOrderListNotify:type_name -> message.SellOrderListNotify
	35, // 28: message.ClientResponse.buySuccessNotify:type_name -> message.BuySuccessNotify
	36, // 29: message.ClientResponse.sellSuccessNotify:type_name -> message.SellSuccessNotify
	37, // 30: message.ClientResponse.closeMarketNotify:type_name -> message.CloseMarketNotify
	38, // 31: message.ClientResponse.openMarketNotify:type_name -> message.OpenMarketNotify
	39, // 32: message.TotalAmountChangeNotify.totalAmounts:type_name -> message.TotalAmountChangeNotify.TotalAmountsEntry
	1,  // 33: message.SquidBetInfoNotify.type:type_name -> message.SquidBetInfoEnumType
	16, // 34: message.SquidBetInfoNotify.track:type_name -> message.Track
	19, // 35: message.SquidRoundNotify.rounds:type_name -> message.Round
	22, // 36: message.GlassSettleDoneNotify.orders:type_name -> message.Order
	40, // 37: message.LadderStageNotify.bets:type_name -> message.LadderStageNotify.BetsEntry
	22, // 38: message.LadderSettleDoneNotify.orders:type_name -> message.Order
	41, // 39: message.LadderBetInfoNotify.bets:type_name -> message.LadderBetInfoNotify.BetsEntry
	31, // 40: message.BuyOrderNotify.buyOrderInfo:type_name -> message.BuyOrderInfo
	32, // 41: message.SellOrderNotify.sellOrderInfo:type_name -> message.SellOrderInfo
	31, // 42: message.BuyOrderListNotify.buyOrderInfo:type_name -> message.BuyOrderInfo
	32, // 43: message.SellOrderListNotify.sellOrderInfo:type_name -> message.SellOrderInfo
...
func file_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_message_proto_msgTypes[26].Exporter = func(v any, i int) any {
			switch v := v.(*TradeRecordNotify); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_proto_msgTypes[31].Exporter = func(v any, i int) any {
			switch v := v.(*BuyOrderListNotify); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_proto_msgTypes[32].Exporter = func(v any, i int) any {
			switch v := v.(*SellOrderListNotify); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_proto_msgTypes[34].Exporter = func(v any, i int) any {
			switch v := v.(*SellSuccessNotify); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_proto_msgTypes[35].Exporter = func(v any, i int) any {
			switch v := v.(*CloseMarketNotify); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_message_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*ClientResponse_TradeRecordNotify)(nil),
		(*ClientResponse_BuyOrderNotify)(nil),
		(*ClientResponse_SellOrderNotify)(nil),
		(*ClientResponse_BuyOrderListNotify)(nil),
		(*ClientResponse_SellOrderListNotify)(nil),
		(*ClientResponse_BuySuccessNotify)(nil),
		(*ClientResponse_SellSuccessNotify)(nil),
		(*ClientResponse_CloseMarketNotify)(nil),
		(*ClientResponse_OpenMarketNotify)(nil),
	}
	type x struct{}
